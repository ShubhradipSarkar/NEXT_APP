...
export default function UserProfile({params}) {
    ...
    return (
        ...
        <div className='min-h-screen'>
            ...
            <center><div><Textarea value={text} onChange={(e)=>{settext(e.target.value)}} className='w-2/3 p-3'/> <Button onClick={updateContent} size='sm' className='m-2'>Update Content </Button></div></center>
            </div>
            }
            <Footer_/>
        </div>
